...
int Car::setSpeedInConstructor(int max_speed)
{
	VMax = max_speed;
	srand(time(NULL));
	V = ((rand() % VMax) + 1);
...
{
	speed_pass = setSpeedInConstructor(max_speed_pass);
...
{
	speed_6m = setSpeedInConstructor(max_speed_6m);
...
{
	speed_7m = setSpeedInConstructor(max_speed_7m);
...
{
	speed_14m = setSpeedInConstructor(max_speed_14m);
...
{
	speed_15m = setSpeedInConstructor(max_speed_15m);
...
{
	speed_17m = setSpeedInConstructor(max_speed_17m);
...
{
	speed_19m = setSpeedInConstructor(max_speed_19m);
...
{
	speed_25m = setSpeedInConstructor(max_speed_25m);
